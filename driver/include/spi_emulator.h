...
class SpiEmulator : public ISpiInterface
{
  ...
  public:
    ...
    uint8_t *get_pCopi() { return &fake_copi_buffer; }

    uint8_t *get_pCipo() { return &fake_cipo_buffer; }

    uint16_t get_raw_adc_test_val(uint8_t idx) { return adc.get_raw_adc_test_val(idx); }
    ///////////////////// END OF WARNING /////////////////////
